...
<body>
    ...
    <div class="address-bar">Mumbai | India | 123.456.7890</div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-md-6">
                    <p>The Perfect Cup launched in 2020, in the heart of Mumbai. Our mission is simple. We want to teach coffee drinkers all over the world how to make the perfect blend!
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-sm-4 text-center">
                    <img class="img-responsive" src="img/spongbob.jpg" alt="">
                    <h3>Sumeet Sonawane</h3>
                </div>
                <div class="col-sm-3 text-center">
                    <img class="img-responsive" src="img/patrick.jpg" alt="">
                    <h3>Patrick star</h3>
                </div>
                <div class="col-sm-4 text-center">
                    <img class="img-responsive" src="img/squidward.jpg" alt="">
                    <h3>Squidward</h3>
                </div>
                <div class="clearfix"></div>
            </div>
